...
const SLOT_POSITIONS = [
  { x: 38,  y: 196, r:  -8 },  // 1번째 → 아래줄 왼쪽
  { x: 128, y: 201, r:   2 },  // 2번째 → 아래줄 가운데
  { x: 213, y: 191, r:   8 },  // 3번째 → 아래줄 오른쪽
  { x: 48,  y: 151, r: -10 },  // 4번째 → 윗줄 왼쪽
  { x: 138, y: 156, r:   4 },  // 5번째 → 윗줄 가운데
  { x: 206, y: 146, r:  -6 },  // 6번째 → 윗줄 오른쪽
]
