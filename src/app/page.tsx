...
const SLOT_POSITIONS = [
  { x: 28,  y: 200, r:  -8 },  // 1번째 → 아래줄 왼쪽
  { x: 140, y: 200, r:   2 },  // 2번째 → 아래줄 가운데
  { x: 240, y: 200, r:   8 },  // 3번째 → 아래줄 오른쪽
  { x: 35,  y: 135, r: -10 },  // 4번째 → 윗줄 왼쪽
  { x: 148, y: 135, r:   4 },  // 5번째 → 윗줄 가운데
  { x: 250, y: 135, r:  -6 },  // 6번째 → 윗줄 오른쪽
]
